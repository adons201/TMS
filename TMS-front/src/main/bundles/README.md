...
frontend files/resources for your projectEntity (frontend development bundle).
...
If your projectEntity development needs a hot deployment of the frontend changes, 
